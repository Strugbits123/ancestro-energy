...
<Button
  ...
  className="backdrop-blur-sm hidden sm:flex fixed right-[-50px] bottom-[35%] rotate-90 animate-top-to-bottom-hop z-50 
...
<Controller
      ...
      <section className="relative min-h-screen flex flex-col justify-center pt-[100px]">
        <div
